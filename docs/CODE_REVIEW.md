...
>
> **本文档是 2026-07-30 的定点快照，下方"优先级"列表已过时，不再维护同步。** 2026-08-03 明确了项目定位（编排/适配层，类比 LiteLLM，见 [PROGRESS.md](PROGRESS.md#项目定位)）之后，当前有效的路线图和优先级统一维护在 [PROGRESS.md 的"路线图 / 已知缺口"一节](PROGRESS.md#路线图--已知缺口)，请以那里为准。
